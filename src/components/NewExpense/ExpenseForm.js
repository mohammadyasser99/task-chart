...
// we put a props in the function to pass the data from the child to the parent component
const ExpenseForrm = (props) => {
const [enterTitle,setEnteredTitle] = useState('')
const [enterAmount,setEnteredAmount] = useState('')
const [enterDate,setEnteredDate] = useState('')

//we can use one state for all the values
...
//     })
  ...
  const amountChangeHandler = (event) => {
    ...
    //this is a shared handler function
...
const submitHandler = (event) => {
    ...
    // then we excute the function in the parent component
